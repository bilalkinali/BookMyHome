...
using AddressServiceDawa.Domain;
using AddressServiceDAWA.Domain.Values;

namespace AddressServiceDAWA.Domain.Entity;
...
public class Address : DomainEntity
{
    ...
    protected Address(Guid dawaCorrelationId, string street, string building, string zipCode, string city,
        DawaAddress dawaAddress, AddressHashCode addressHashCode)
    {
        Street = street;
        Building = building;
        City = city;
    ...
    public static Address Create(Guid dawaCorrelationId, string street, string building, string zipCode, string city,
